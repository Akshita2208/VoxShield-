...
const STAGES = [
  { 
    id: "detect", 
    title: "DETECT", 
    desc: "Analyze voice signals for synthetic or manipulated audio.", 
    icon: Mic, 
    color: "#2563EB", 
  ...
  { 
    id: "verify", 
    title: "VERIFY", 
    desc: "Optionally verify whether the speaker matches a trusted identity.", 
    icon: Fingerprint, 
    color: "#06B6D4", 
  ...
  { 
    id: "assess", 
    title: "ASSESS", 
    desc: "Combine voice and context signals to determine risk.", 
    icon: BarChart3, 
    color: "#7C6FF6", 
  ...
  { 
    id: "prevent", 
    title: "PREVENT", 
    desc: "Apply the appropriate security action when risk is high.", 
    icon: ShieldCheck, 
    color: "#16A34A", 
    ...
    <div className="mb-12">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
        <div>
          ...
          <p className="text-sm text-muted">VoxShield provides a continuous protection pipeline</p>
        </div>
